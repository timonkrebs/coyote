...
- Install the [.NET 10.0 version of the coyote tool](../../get-started/install.md).
...
```plain
coyote test ./Samples/bin/net10.0/Monitors.dll --iterations 1000 -ms 200
```
...
```plain
coyote test ./Samples/bin/net10.0/Monitors.dll --iterations 1000 -ms 200 -s prioritization -sv 10
```
...
..... Writing .\Samples\bin\net10.0\Output\Monitors.exe\CoyoteOutput\Monitors_0_0.txt
..... Writing .\Samples\bin\net10.0\Output\Monitors.exe\CoyoteOutput\Monitors_0_0.trace
```
...
```plain
coyote replay ./Samples/bin/net10.0/Monitors.dll
    .\Samples\bin\net10.0\Output\Monitors.exe\CoyoteOutput\Monitors_0_0.trace

. Reproducing trace in ./Samples/bin/net10.0/Monitors.exe
... Reproduced 1 bug.
...
```plain
coyote test ./Samples/bin/net10.0/Monitors.dll --iterations 10 --max-steps 20 --actor-graph
```
...
```plain
... Emitting graph:
..... Writing .\Samples\bin\net10.0\Output\Monitors.exe\CoyoteOutput\Monitors_0_1.dgml
```
