...
```plain
./Samples/bin/net10.0/DrinksServingRobotActors.exe
```
...
```plain
coyote test ./Samples/bin/net10.0/DrinksServingRobotActors.dll -i 1000 -ms 2000 -s prioritization -sv 10
```

Chances are this will find a bug quickly, and you will see output from the test like this:

```plain
. Testing .\Samples\bin\net10.0\DrinksServingRobotActors.exe
...
`.bin\net10.0\Output\DrinksServingRobot.exe\CoyoteOutput\DrinksServingRobot_0_1.txt`. This log can be
...
```plain
coyote test .\Samples\bin\net10.0\DrinksServingRobotActors.dll -i 1000 -ms 2000 -s prioritization -sv 10 --actor-graph
```
