...
```plain
./Samples/bin/net10.0/CoffeeMachineTasks.exe
```
...
```plain
coyote rewrite ./Samples/bin/net10.0/CoffeeMachineTasks.dll
```

Then you can run the test:

```plain
coyote test ./Samples/bin/net10.0/CoffeeMachineTasks.dll -i 1000 -ms 500 -s fair-prioritization -sv 10
```
...
```plain
.\Samples\bin\net10.0\Output\CoffeeMachineTasks.exe\CoyoteOutput\CoffeeMachine_0_0.txt
```
