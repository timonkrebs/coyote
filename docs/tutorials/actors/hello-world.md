...
```plain
"./Samples/bin/net10.0/HelloWorldActors.exe"
```
...
```plain
coyote test ./Samples/bin/net10.0/HelloWorldActors.dll --iterations 30
```

The result is:

```plain
. Testing .\Samples\bin\net10.0\HelloWorldActors.dll
...
..... Writing .\Samples\bin\net10.0\Output\HelloWorldActors.exe\CoyoteOutput\HelloWorldActors_0_2.txt
..... Writing .\Samples\bin\net10.0\Output\HelloWorldActors.exe\CoyoteOutput\HelloWorldActors_0_2.trace
...
```plain
coyote test ./Samples/bin/net10.0/HelloWorldActors.exe --iterations 30
```
