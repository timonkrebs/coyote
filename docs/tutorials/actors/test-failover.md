...
```plain
./Samples/bin/net10.0/CoffeeMachineActors.exe
```
...
```plain
coyote test ./Samples/bin/net10.0/CoffeeMachineActors.dll -i 100 -ms 2000 -s prioritization -sv 10 --actor-graph
```
...
```plain
.\Samples\bin\net10.0\Output\CoffeeMachineActors.exe\CoyoteOutput\CoffeeMachine_0_0.txt
.\Samples\bin\net10.0\Output\CoffeeMachineActors.exe\CoyoteOutput\CoffeeMachine_0_0.dgml
```
