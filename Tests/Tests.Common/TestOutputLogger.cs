...
{
    /// <summary>
    /// Logger that writes to the xUnit v3 test output. This mirrors the
    /// <see cref="SystematicTesting.Frameworks.XUnit.TestOutputLogger"/> shipped in the
    /// Microsoft.Coyote.Test package, which is bound to the xUnit v2 abstractions for
    /// compatibility with external consumers and thus cannot accept the v3 helper.
    /// </summary>
