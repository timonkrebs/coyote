...
{
    public class ValueTaskTaskConfigureAwaitTrueTests : BaseBugFindingTest
    {
        public ValueTaskTaskConfigureAwaitTrueTests(ITestOutputHelper output)
            : base(output)
        {
        }
        ...
        public async Task TestAwaitSynchronousValueTaskWithResult()
        {
            ...
            {
                SharedEntry entry = new SharedEntry();
                int value = await entry.GetWriteResultAsync(5).ConfigureAwait(true);
        ...
        public async Task TestAwaitSynchronousValueTaskWithResultFailure()
        {
            ...
            {
                SharedEntry entry = new SharedEntry();
                int value = await entry.GetWriteResultAsync(3).ConfigureAwait(true);
                Specification.Assert(value == 5, "Value is {0} instead of 5.", value);
            },
            configuration: this.GetConfiguration().WithTestingIterations(200),
            expectedError: "Value is 3 instead of 5.",
        ...
        public async Task TestAwaitAsynchronousValueTaskWithResult()
        {
            ...
            {
                SharedEntry entry = new SharedEntry();
                int value = await entry.GetWriteResultWithDelayAsync(5).ConfigureAwait(true);
                Specification.Assert(value == 5, "Value is {0} instead of 5.", value);
            },
            configuration: this.GetConfiguration().WithTestingIterations(200));
        }
        ...
        public async Task TestAwaitAsynchronousValueTaskWithResultFailure()
        {
            ...
            {
                SharedEntry entry = new SharedEntry();
                int value = await entry.GetWriteResultWithDelayAsync(3).ConfigureAwait(true);
                Specification.Assert(value == 5, "Value is {0} instead of 5.", value);
            },
            configuration: this.GetConfiguration().WithTestingIterations(200),
            expectedError: "Value is 3 instead of 5.",
        ...
        {
            await ValueTask.CompletedTask;
            return await entry.GetWriteResultAsync(value).ConfigureAwait(true);
        }
#endif
